...
export type ShipDetailQueryVariables = Exact<{
  id: Scalars['ID'];
}>;


export type ShipDetailQuery = { __typename?: 'Query', ship?: { __typename?: 'Ship', name?: string | null | undefined, year_built?: number | null | undefined, id?: string | null | undefined, image?: string | null | undefined, roles?: Array<string | null | undefined> | null | undefined } | null | undefined };

export type ShipListQueryVariables = Exact<{ [key: string]: never; }>;


export type ShipListQuery = { __typename?: 'Query', launchesPast?: Array<{ __typename?: 'Launch', ships?: Array<{ __typename?: 'Ship', name?: string | null | undefined, active?: boolean | null | undefined, year_built?: number | null | undefined, type?: string | null | undefined, home_port?: string | null | undefined, id?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined> | null | undefined };


export const ShipDetailDocument = gql`
...
/**
 * __useShipDetailQuery__
 *
 * To run a query within a React component, call `useShipDetailQuery` and pass it any options that fit your needs.
 * When your component renders, `useShipDetailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useShipDetailQuery(baseOptions: Apollo.QueryHookOptions<ShipDetailQuery, ShipDetailQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ShipDetailQuery, ShipDetailQueryVariables>(ShipDetailDocument, options);
      }
export function useShipDetailLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ShipDetailQuery, ShipDetailQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ShipDetailQuery, ShipDetailQueryVariables>(ShipDetailDocument, options);
        }
export type ShipDetailQueryHookResult = ReturnType<typeof useShipDetailQuery>;
export type ShipDetailLazyQueryHookResult = ReturnType<typeof useShipDetailLazyQuery>;
export type ShipDetailQueryResult = Apollo.QueryResult<ShipDetailQuery, ShipDetailQueryVariables>;
...
/**
 * __useShipListQuery__
 *
 * To run a query within a React component, call `useShipListQuery` and pass it any options that fit your needs.
 * When your component renders, `useShipListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useShipListQuery({
 *   variables: {
 *   },
 * });
 */
export function useShipListQuery(baseOptions?: Apollo.QueryHookOptions<ShipListQuery, ShipListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ShipListQuery, ShipListQueryVariables>(ShipListDocument, options);
      }
export function useShipListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ShipListQuery, ShipListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ShipListQuery, ShipListQueryVariables>(ShipListDocument, options);
        }
export type ShipListQueryHookResult = ReturnType<typeof useShipListQuery>;
export type ShipListLazyQueryHookResult = ReturnType<typeof useShipListLazyQuery>;
export type ShipListQueryResult = Apollo.QueryResult<ShipListQuery, ShipListQueryVariables>;